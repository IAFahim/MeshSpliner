...
namespace sc.splinemesher.pro.runtime
{
    ...
    public class CurveMeshSettings
    {
        ...
        public struct OutputMesh
        {
            ...
            [Tooltip("Decide how the output meshes are segmented. The amount of segments and their size is a factor you can decide upon based project needs and circumstances." +
                     "\n\n" +
                     "\"Segmenting the final mesh is important for culling and rendering performance.\"")]
            public Segmenting segmentingMode;
            
            [Tooltip("Specify how long the mesh is allowed to be, before it is split up into a separate mesh object." +
                     "\n\n" +
                     "Note that the final mesh may be one tile longer or shorter than this value, due to stretching and rounding.")]
            [Min(0f)]
            ...
            public static OutputMesh Default()
            {
                ...
                {
                    segmentingMode = Segmenting.ByLength,
                    segmentCount = 1,
