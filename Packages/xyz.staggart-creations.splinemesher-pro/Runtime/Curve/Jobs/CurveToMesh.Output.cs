    ...
    public partial struct CurveToMesh
    {
        ...
        public Mesh CreateMesh(ref Mesh mesh, int index, bool readable, bool validateIndices = false)
        {
            ...
            */
            ...
            mesh.SetSubMeshes(descriptors, noValidation);
        ...
        public Mesh CreateCollider(ref Mesh mesh, string name = "SplineMesh")
        {
            ...
            mesh.SetVertexBufferData(colliderVertices, 0, 0, colliderVertexCount, 0, noValidation);
            
            //Triangles
            var triangleValidation = MeshUpdateFlags.DontRecalculateBounds | MeshUpdateFlags.DontResetBoneBounds;
