...
namespace sc.splinemesher.pro.editor
{
    public static class SplineCurveSettingsEditor
    {
        ...
        public class UV : UI.Section.SectionEditor
        {
            ...
            public override void OnInspectorGUI(ref bool changed)
            {
                component.drawUV = GUILayout.Toggle(component.drawUV, new GUIContent(" Visualize", EditorGUIUtility.IconContent((component.drawUV ? "animationvisibilitytoggleon" : "animationvisibilitytoggleoff")).image, 
                    "Toggle UV inspection"), "Button", GUILayout.Width(90f));
        ...
        public class Collision : UI.Section.SectionEditor
        {
            ...
            SerializedProperty includeLayers;
        ...
        public class OutputMesh : UI.Section.SectionEditor
        {
            ...
            private SerializedProperty segmentingMode;
            ...
            public override void OnEnable()
            {
                ...
                segmentingMode = settings.FindPropertyRelative("segmentingMode");
                maxSegmentLength = settings.FindPropertyRelative("maxSegmentLength");
                segmentCount = settings.FindPropertyRelative("segmentCount");
            ...
            public override void OnInspectorGUI(ref bool changed)
            {
                ...
                using (new EditorGUILayout.HorizontalScope())
                {
                    EditorGUILayout.PropertyField(segmentingMode, new GUIContent("Segmenting", segmentingMode.tooltip),GUILayout.Width(EditorGUIUtility.labelWidth + 90f));

                    component.drawSegments = GUILayout.Toggle(component.drawSegments,
                        new GUIContent("", EditorGUIUtility.IconContent((component.drawSegments ? "animationvisibilitytoggleon" : "animationvisibilitytoggleoff")).image, "Visualize with colors"), "MiniButtonRight", GUILayout.MaxWidth(30f),
                        GUILayout.MaxHeight(19f));
                }

                EditorGUI.indentLevel++;
                if (segmentingMode.intValue == (int)CurveMeshSettings.OutputMesh.Segmenting.ByLength)
                {
                    EditorGUILayout.PropertyField(maxSegmentLength, new GUIContent("Maximum length", maxSegmentLength.tooltip), GUILayout.Width(EditorGUIUtility.labelWidth + 50f));
                }
                else if (segmentingMode.intValue == (int)CurveMeshSettings.OutputMesh.Segmenting.Specific)
                {
                    EditorGUILayout.PropertyField(segmentCount, GUILayout.Width(EditorGUIUtility.labelWidth + 50f));
                }
                EditorGUI.indentLevel--;
